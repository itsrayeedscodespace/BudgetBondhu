      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image src="/images/contact.jpg" alt="Contact us background" fill className="object-cover" />
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="bg-zinc-900 border-zinc-800 text-zinc-100">
                <CardHeader>
                  <CardTitle className="text-orange-400">{t("sendMessage")}</CardTitle>
                  <CardDescription className="text-zinc-400">{t("sendMessageDesc")}</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-900 border-zinc-800 text-zinc-100">
                  <CardHeader>
                    <CardTitle className="text-orange-400">{t("contactInformation")}</CardTitle>
                    <CardDescription className="text-zinc-400">{t("contactInformationDesc")}</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-start gap-3">
                      <Mail className="h-5 w-5 text-orange-400 mt-0.5" />
                      <div>
                        <h3 className="font-medium text-zinc-200">{t("email")}</h3>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-zinc-200">{t("phone")}</h3>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-zinc-200">{t("address")}</h3>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-zinc-200">{t("hours")}</h3>
                        <p className="text-zinc-400">
