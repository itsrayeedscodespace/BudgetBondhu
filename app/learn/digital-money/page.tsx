...
export default function DigitalMoneyPage() {
  ...
  const courseInfo = {
    ...
    description:
      "Learn about modern banking, digital currencies, and how technology is changing the way we handle money.",
    duration: `3 ${t("weeks")}`,
    totalLessons: 9,
      ...
      lessons: [
        {
          ...
          type: "video",
          duration: `18 ${t("min")}`,
          description: "Understanding how banks operate in the digital age.",
        },
        {
          id: 2,
          ...
          type: "reading",
          duration: `15 ${t("min")}`,
          description: "Comparing digital and traditional banking services.",
        },
        {
          id: 3,
          ...
          type: "quiz",
          duration: `12 ${t("min")}`,
          description: "Test your knowledge about safe banking practices.",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          id: 4,
          title: "Mobile Wallets Explained",
          type: "video",
          duration: `20 ${t("min")}`,
          description: "How mobile payment apps work and their benefits.",
        },
        {
          id: 5,
          ...
          type: "reading",
          duration: `16 ${t("min")}`,
          description: "Keeping your digital payments safe and secure.",
        },
        {
          id: 6,
          ...
          type: "video",
          duration: `14 ${t("min")}`,
          description: "Overview of different digital payment options.",
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          type: "reading",
          duration: `18 ${t("min")}`,
          description: "Understanding popular cryptocurrencies and their uses.",
        },
        {
          id: 9,
          title: "Digital Money Final Quiz",
          type: "quiz",
          duration: `20 ${t("min")}`,
          description: "Comprehensive assessment of digital money concepts.",
        },
      ],
    },
  ]
